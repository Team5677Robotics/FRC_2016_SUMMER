...
public class TrajectoryGenerator {
  ...
  /**
   * Using the third kinematic equation we calculate the max velocity the robt can travel based off
   * of the desired distance we want to travel. Then we compare this calculated velocity to the max
   * velocity that the robot can actually do and returns the minimum value.
   *
