...
public class GamepadWrapper extends Joystick {
  ...
  /**
   * Gets whether or not the Right Button on the DPad is pressed. Since the DPad is an axis, the
   * code checks to see if the button is pushed significantly far enough to the right.
   *
   * @return The state of the button
   */
  ...
  /**
   * Gets whether or not the Left Button on the DPad is pressed. Since the DPad is an axis, the code
   * checks to see if the button is pushed significantly far enough to the left.
   *
   * @return The state of the button
   */
  ...
  /**
   * Gets whether or not the Up Button on the DPad is pressed. Since the DPad is an axis, the code
   * checks to see if the button is pushed significantly far enough to the left.
   *
   * @return The state of the button
   */
  ...
  /**
   * Gets whether or not the Down Button on the DPad is pressed. Since the DPad is an axis, the code
   * checks to see if the button is pushed significantly far enough to the left.
   *
   * @return The state of the button
   */
